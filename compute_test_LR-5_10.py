...
# ImageJ处理拼接的临时文件夹
srTempPath = "/mnt/sda/lt/new_dataset/incoherent_RGBchannels/test/output"
...
generator.load_state_dict(
    torch.load(r"/home/lt/python/eventually/result_new_ssim/LR-5_10/2025-05-11--10-16-58/epoch100-model_psnr_best.pth"))
generator.to(device)
